...
<table width="950" height="118" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 $id=$_SESSION["hy_id"];
 $query=mysql_query("select * from hy where hy_id='$id'");
...
?>
          <form action="save_hy.php?act=edit" method="post" name="form10" id="form10">
            ...
            <tr>
              ...
              <td width="69%" align="left" valign="middle"><input name="username" type="text" class="text12" id="username" value="<?php echo $rs["userid"]?>"></td>
            </tr>
            <tr>
              <td height="35" align="right" valign="middle" class="text12">会员密码：</td>
              <td align="left" valign="middle"><input name="userpwd" type="password" class="text12" id="userpwd" value="<?php echo $rs["password"]?>"></td>
            </tr>

            <tr>
              <td height="35" align="right" valign="middle" class="text12">性别：</td>
              <td align="left" valign="middle"><span class="text12">
                <input name="sex" type="radio" value="男" <? if($rs['sex']=='男') echo "checked"?> />
男
...
女</span></td>
            ...
            <tr>
              ...
              <td align="left" valign="middle"><input name="tel" type="text" class="text12" id="tel"value="<?php echo $rs["tel"]?>"></td>
            </tr>
            <tr>
              <td height="35" align="right" valign="middle" class="text12">邮箱：</td>
              <td align="left" valign="middle"><input name="email" type="text" class="text12" id="email"value="<?php echo $rs["email"]?>"></td>
            </tr>
            <tr>
              <td height="35">&nbsp;</td>
