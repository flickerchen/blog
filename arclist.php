  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<?php
 $execc="select count(*) from arc where category=2";
...
$nextpage=$page+1;
$prepage=$page-1;
$exec="select * from arc where category=2 order by arc_id desc limit ".($page*$pagesize).",$pagesize"; 
...
?>
	...
	<a href="show_arc.php?id=<?php echo $rs["arc_id"]?>" class="lvext14"><?=$rs["title"];?></a></td>
              ...
              <tr>
                <td><span class="linetext"><?=str_replace('kk','昇',$rs["des"]);?></span></td>
              </tr>
